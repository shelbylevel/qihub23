...
```{r ooi-index-2018-tract, fig.cap = "Figure 3: Ohio Opportunity Index by Census Tract", fig.height = 9, fig.width = 9, include = TRUE}
...
```{r ooi-crime-2018-tract, fig.cap = "Figure 3: Ohio Crime Index by Census Tract", fig.height = 9, fig.width = 9, include = TRUE}
...
```{r ooi-education-2018-tract, fig.cap = "Figure 3: Ohio Education Index by Census Tract", fig.height = 9, fig.width = 9, include = TRUE}
...
```{r ooi-employ-2018-tract, fig.cap = "Figure 3: Ohio Employment Index by Census Tract", fig.height = 9, fig.width = 9, include = TRUE}
...
```{r ooi-env-2018-tract, fig.cap = "Figure 3: Ohio Environment Index by Census Tract", fig.height = 9, fig.width = 9, include = TRUE}
...
```{r ooi-health-2018-tract, fig.cap = "Figure 3: Ohio Health Index by Census Tract", fig.height = 9, fig.width = 9, include = TRUE}
...
```{r ooi-trans-2018-tract, fig.cap = "Figure 3: Ohio Transportation Index by Census Tract", fig.height = 9, fig.width = 9, include = TRUE}
...
```{r ooi-house-2018-tract, fig.cap = "Figure 3: Ohio Housing Index by Census Tract", fig.height = 9, fig.width = 9, include = TRUE}
...
Construction of the OCOI consisted of the following broad steps:
1. Operationalize each measure from original, “raw” data
2. Summarize the measure for each Ohio census tract as a rate, count, or level
3. Standardize each variable, as needed, to yield consistency across measures and domains
4. Synthesize the measures in each domain to create a “domain score”
...
url0 = "https://grc.osu.edu/sites/default/files/inline-files/coi_v1.1.zip"
destfile <- tempfile()
download.file(url0, destfile, mode = 'wb')
read.csv(
  destfile, sheet = 1
...
```{r coi-index-2017-tract, fig.cap = "Figure 3: Ohio Children's Opportunity Index by Census Tract", fig.height = 9, fig.width = 9, include = TRUE}
...
```{r coi-fam-tability-2017-tract, fig.cap = "Figure 3: Ohio Chilren's Family Stability Index by Census Tract", fig.height = 9, fig.width = 9, include = TRUE}
...
```{r coi-infant-2017-tract, fig.cap = "Figure 3: Ohio Infant Health Index by Census Tract", fig.height = 9, fig.width = 9, include = TRUE}
...
```{r coi-child-2017-tract, fig.cap = "Figure 3: Ohio Children's Health Index by Census Tract", fig.height = 9, fig.width = 9, include = TRUE}
...
```{r coi-housing-2017-tract, fig.cap = "Figure 3: Ohio Children's Housing Index by Census Tract", fig.height = 9, fig.width = 9, include = TRUE}
...
```{r coi-access-2017-tract, fig.cap = "Figure 3: Ohio Children's Access Index by Census Tract", fig.height = 9, fig.width = 9, include = TRUE}
...
```{r coi-education-2017-tract, fig.cap = "Figure 3: Ohio Children's Education Index by Census Tract", fig.height = 9, fig.width = 9, include = TRUE}
...
```{r coi-env-2017-tract, fig.cap = "Figure 3: Ohio Children's Environment Index by Census Tract", fig.height = 9, fig.width = 9, include = TRUE}
...
```{r coi-crime-2017-tract, fig.cap = "Figure 3: Ohio Children's Crime Index by Census Tract", fig.height = 9, fig.width = 9, include = TRUE}

...
readxl::read_excel(
  ...
  mutate(
    tractfips = as.numeric(tractfips)
    ) -> sdoh_tract
...
zcta_df %>%
  ...
  filter(
    zipcode_num %in% c(45710, 45711, 45701, 45716, 45719, 43728, 45723, 45732, 45735, 45740, 45742, 45761, 45764, 45766, 45776, 45778, 45780, 45782)
  ) %>%
  ggplot() +
  geom_sf(
    aes(fill = zipcode),
...
```{r athens-tract-pop-map, include = TRUE, fig.cap = "Athens County Population by Census Tract", eval=FALSE}
...
```{r app-tract-pop-map, include = TRUE, fig.cap = "Appalachia Population by Census Tract", eval=FALSE}
...
```{r add-geometry-to-sdoh-data, include = FALSE, eval=FALSE}
df_county %>%
  inner_join(
    sdoh_county,
    by = c("GEOID" = "countyfips")
...
```{r median-household-income-county, fig.cap = "Median Household Income by County", fig.height = 9, fig.width = 9, include = TRUE, eval=FALSE}
...
```{r median-household-income-zipcode, fig.cap = "Median Household Income by Zip Code", fig.height = 9, fig.width = 9, include = TRUE, eval=FALSE}
...
```{r median-household-income-tract, fig.cap = "Median Household Income by Census Tract", fig.height = 9, fig.width = 9, include = TRUE, eval=FALSE}
